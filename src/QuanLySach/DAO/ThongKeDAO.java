...
public class ThongKeDAO {
    public ThongKe getThongKe(int nam) {
        ...
        int tongDoanhThu = tongThuQuy[0]+tongThuQuy[1]+tongThuQuy[2]+tongThuQuy[3];
    ...
    private String[] getDateString(int nam, int quy) {
        ...
        String strBatDau = namBatDau + thangBatDau + "01";
        String strKetThuc = namKetThuc + thangKetThuc + "01";
        kq[0] = strBatDau;
        kq[1] = strKetThuc;
        return kq;
    }
