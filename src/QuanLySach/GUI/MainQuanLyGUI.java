...
//    PnQuanLyNhapHangGUI nhapHangPanel;
    ...
    final Color clLeftItem = new Color(0, 0, 0);
//    final Color clLeftItemHover = new Color(102, 205, 170);
    final Color clLeftItemHover = new Color(61, 61, 61);

//    final Color clLeftItemSelected = new Color(242, 153, 74);
    final Color clLeftItemSelected = new Color(54, 53, 53);
...
//        lblTitleText = new JLabel(new ImageIcon("image/ManagerUI/title-text.png"));
        lblTitleText = new JLabel("SevenShop");
   
        lblTitleText.setFont(new Font("Arial", Font.BOLD, 45)); // Cài đặt font và kích thước cho tiêu đề
        lblTitleText.setForeground(Color.WHITE); // Thiết lập màu chữ cho tiêu đề
        int width = this.getWidth(); // Lấy chiều rộng của cửa sổ
        int textWidth = lblTitleText.getPreferredSize().width; // Lấy chiều rộng của chuỗi "SevenShop"
        lblTitleText.setBounds((width - textWidth) / 2, 3, textWidth, 38); // Đặt vị trí cho tiêu đề
...
//        lblTitleText.setBounds(width / 2 - 686 / 2, 3, 686, 38);
        ...
        JLabel lblAvatar = new JLabel(new ImageIcon("image/ManagerUI/logo.jpg"), JLabel.CENTER);
