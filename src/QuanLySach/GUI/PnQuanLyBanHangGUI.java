...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    JTextField txtMinSearch, txtMaxSearch, txtMinNgayLap, txtMaxNgayLap, txtMaSP;
    ...
    private void addControlsBanHang() {
        ...
        //căn giữa nội dung từ trái sang phải
        ...
        //đặt kích thước cho một đối tượng
        ...
        dtmSanPhamBan.addColumn("Size");
        dtmSanPhamBan.addColumn("Color");
        tblBanHang = new MyTable(dtmSanPhamBan);

        // định dạng hiển thị thông tin ở giữa
     ...
     // Tạo nút Thêm vào giỏ
        btnThemVaoGio = new JLabel("Thêm vào giỏ");
        btnThemVaoGio.setFont(font);
        btnThemVaoGio.setForeground(Color.decode("#545353"));
        btnThemVaoGio.setHorizontalTextPosition(JLabel.CENTER);
        btnThemVaoGio.setVerticalTextPosition(JLabel.CENTER);
     ...
     // Tạo nút Xóa
        btnXoaSPGioHang = new JLabel("Xoá");
        btnXoaSPGioHang.setFont(font);
        btnXoaSPGioHang.setForeground(Color.decode("#545353"));
        btnXoaSPGioHang.setHorizontalTextPosition(JLabel.CENTER);
        btnXoaSPGioHang.setVerticalTextPosition(JLabel.CENTER);
        btnXoaSPGioHang.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));

        // Tạo nút Xuất hoá đơn
        btnXuatHoaDonSP = new JLabel("Xuất hoá đơn");
        btnXuatHoaDonSP.setFont(font);
        btnXuatHoaDonSP.setForeground(Color.decode("#545353"));
        btnXuatHoaDonSP.setHorizontalTextPosition(JLabel.CENTER);
        btnXuatHoaDonSP.setVerticalTextPosition(JLabel.CENTER);
        btnXuatHoaDonSP.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
...
//                	lbl.setForeground(Color.decode("#000000"));
                ...
                public void mouseExited(MouseEvent e) {
                    lbl.setIcon(new ImageIcon("image/ManagerUI/btn-BanHang.png"));
//                	lbl.setForeground(Color.decode("#545353"));
                }
            });
        }
        ...
        JLabel lblMaHD, lblNgayLap, lblMaKH, lblMaNV, lblTongTien, lblGhiChu, lblMinsearch , lblMaxSearch, lblMinNgay, lblMaxNgay, lblMaSP;
   ...
   private void loadDataTableSanPhamBan() {
    ...
    private void xuLyXuatHoaDonBanHang() {
        ...
        for (int i = 0; i < row; i++) {
            ...
            tongTien += Double.parseDouble((tblGioHang.getValueAt(i, 4) + "").replace(".", ""));
            dsGioHang.add(vec);
        }
